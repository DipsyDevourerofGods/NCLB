...
function GovernmentNewRepublic:ElectionHeld()
	...
	if self.chief_of_state ~= GlobalValue.Get("ChiefOfState") then
		...
		local Bulwark2 = Find_Object_Type("Bulwark_II")
		local Remonda = Find_Object_Type("MC80B")
		...
		if self.chief_of_state == "DUMMY_CHIEFOFSTATE_TEVV" then
			...
			if not self.mediator then
				...
				NewRep.Unlock_Tech(Bulwark2)
				NewRep.Lock_Tech(Remonda)
			end
		else
			...
			if not self.mediator then
				...
				NewRep.Lock_Tech(Bulwark2)
				NewRep.Unlock_Tech(Remonda)
			end
		end
...
function GovernmentNewRepublic:UpdateDisplay()
	...
	if self.RepublicPlayer.Is_Human() then
		...
		government_display_event.Add_Dialog_Text("TEXT_NONE")
		local admiral_list = GlobalValue.Get("NR_GENERAL_LIST")
		if admiral_list ~= nil then
			for index, obj in pairs(admiral_list) do
				government_display_event.Add_Dialog_Text(obj)
			end
		...
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_HERO_SYSTEM_3")
		...
		government_display_event.Add_Dialog_Text("TEXT_DOCUMENTATION_BODY_SEPARATOR")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_LIST")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_CALRISSIAN")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_NORTHAL")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_KRYLL")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_GARRET")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_MADINE")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_CRACKEN")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_TASKEEN")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_JAMIRO")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_TANTOR")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_TULON")
		government_display_event.Add_Dialog_Text("TEXT_GOVERNMENT_NEW_REPUBLIC_GENERAL_VEERTAG")
