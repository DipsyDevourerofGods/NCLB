...
function Find_Faction(message)
  if message == OnEnter then
	...
	tech_unit = Find_Object_Type("IMPERIAL_STORMTROOPER_SQUAD")
	p_kamino.Unlock_Tech(tech_unit)
	tech_unit = Find_Object_Type("IMPERIAL_COMPFORCE_OBSERVE_TEAM")
	p_kamino.Unlock_Tech(tech_unit)
	...
	p_kamino.Lock_Tech(tech_unit)
	tech_unit = Find_Object_Type("ZSINJ_EVO_TROOPER_SQUAD")
	p_kamino.Lock_Tech(tech_unit)
	tech_unit = Find_Object_Type("ZSINJ_INCINERATOR_STORMTROOPER_SQUAD")
	p_kamino.Lock_Tech(tech_unit)
	tech_unit = Find_Object_Type("ZSINJ_74Z_BIKE_COMPANY")
	p_kamino.Lock_Tech(tech_unit)
	tech_unit = Find_Object_Type("ZSINJ_MODIFIED_LAAT_GROUP")
	p_kamino.Lock_Tech(tech_unit)
